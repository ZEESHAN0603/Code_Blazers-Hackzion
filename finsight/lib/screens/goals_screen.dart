...
class GoalsScreen extends StatelessWidget {
  ...
  void _showAddGoalDialog(BuildContext context, MockDataService data) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              data.addGoal(Goal(id: DateTime.now().toString(), name: name.text, targetAmount: double.parse(target.text), savedAmount: double.tryParse(saved.text) ?? 0));
